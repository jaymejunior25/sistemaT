    ...
    <script>
        ...
        function atualizarListaPacotes() {
            ...
            pacotes.forEach(pacote => {
                const prefixo13Digitos = pacote.codigobarrasFiltrado.substring(0, 13);

                // Se o grupo ainda não existir, cria um array para armazenar os pacotes
                if (!grupos[prefixo13Digitos]) {
                    grupos[prefixo13Digitos] = [];
                }
                grupos[prefixo13Digitos].push(pacote);
            });
