                ...
                <ul class="list-group">
                    <?php foreach ($pacotes as $pacote): ?>
                        <li class="list-group-item">
                            <?php echo htmlspecialchars($pacote['descricao']) . ' - ' . htmlspecialchars($pacote['codigobarras']); ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
            <button type="submit" class="btn btn-custom btn-block"> <i class="fas fa-paper-plane"></i>Enviar Todos</button>
        </form>
