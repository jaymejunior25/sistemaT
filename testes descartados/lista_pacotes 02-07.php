                    ...
                    <?php foreach ($pacotes as $pacote): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="excluir_pacote.php?id=<?php echo $pacote['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir este pacote?');">Excluir</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
